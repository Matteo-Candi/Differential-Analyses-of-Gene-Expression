...
required_packages <- c("BiocGenerics", "DESeq2", "psych", "NetworkToolbox", "ggplot2",
                       "GGally", "sna", "network", "TCGAbiolinks", "SummarizedExperiment", "DT", "reticulate")
...
hist(d.n,col = "gold2", main = "Degree distribution - normal tissue")
abline(v=x_n, col="blue3")
...
# [TODO] controlla se è da fare ma in teoria no perche IF SO
...
plot(x[2:length(x)], model$fitted.values, type='l', ylim = c(-6, -1), xlab = 'logarithm of degree', ylab = 'logarith of count', col = 'red', 
...
# [TODO]  stessa cosa di sopra, IF SO non rispettato
